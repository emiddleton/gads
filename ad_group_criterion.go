...
func (s *AdGroupCriterionService) Mutate(adGroupCriterionOperations AdGroupCriterionOperations) (adGroupCriterions AdGroupCriterions, err error) {
	...
	respBody, err := s.Auth.request(adGroupCriterionServiceUrl, "mutate", mutation, nil)
	if err != nil {
...
// Relevant documentation
//
//     https://developers.google.com/adwords/api/docs/reference/v201802/AdGroupCriterionService#mutateLabel
//
func (s *AdGroupCriterionService) MutateLabel(adGroupCriterionLabelOperations AdGroupCriterionLabelOperations) (adGroupCriterionLabels []AdGroupCriterionLabel, err error) {
	...
	mutation := struct {
		...
		Ops: operations}
	respBody, err := s.Auth.request(adGroupCriterionServiceUrl, "mutateLabel", mutation, nil)
	if err != nil {
...
// Query documentation
//
//     https://developers.google.com/adwords/api/docs/reference/v201802/AdGroupCriterionService#query
//
